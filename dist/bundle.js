...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseComponent = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _service = __webpack_require__(169);
	...
	var BaseComponent = function (_React$Component) {
	  ...
	  _createClass(BaseComponent, [{
	    ...
	    key: 'show',
	    value: function show() {
	      _reactDom2.default.findDOMNode(this).classList.remove('hidden');
	      this.focus();
	      this.emit('opened');
	    }
	  }, {
	    key: 'hide',
	    value: function hide() {
	      _reactDom2.default.findDOMNode(this).classList.add('hidden');
	      this.emit('closed');
	    }
	  }, {
	    key: 'focus',
	    ...
	    value: function isHidden() {
	      return _reactDom2.default.findDOMNode(this).classList.contains('hidden');
	    }
	  }, {
	    key: 'isActive',
	    ...
	    key: 'publish',
	    value: function publish(event, detail, noPrefix) {
	    ...
	    key: 'observe',
	    value: function observe(name, value) {
	      if (!this._settings) {
	        this._settings = {};
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Service = {
	  ...
	  debug: function sys_debug() {
	    if (false) {
	      console.log('[Service]' + '[' + Service.currentTime() + ']' + Array.slice(arguments).concat());
	    }
	  }
	};
